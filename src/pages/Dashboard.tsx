...
<div className="flex items-center justify-between p-4 rounded-xl bg-amber-500/10 gap-2">
...
<span className="font-bold text-amber-500 whitespace-nowrap flex-shrink-0">    -$150.00
  </span>
</div>
